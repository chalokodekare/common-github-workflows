 ...
 */
package com.chalocodekare.skeleton.constants;

public class ApiConstants {
    public static final String HEALTH_CHECK_API_END_POINT = "/health";
    public static final String ACTUATOR_HEALTH_CHECK_API_END_POINT = "/actuator/health";
}
